...
class EventScheduler:
    ...
    def get_events_path(self, house_id: str) -> str:
        """获取可调度事件文件路径 - 使用原始数据路径"""
        # 🎯 使用原始数据路径（不是错误约束路径）
        base_original_path = "/home/deep/TimeSeries/Agent_V2/output"
    ...
    def get_output_path(self, house_id: str, season: str = None) -> str:
        """获取输出文件路径 - 输出到鲁棒性实验目录"""
        # 🎯 修改为输出到鲁棒性实验目录
        base_path = "/home/deep/TimeSeries/Agent_V2/experiments/Robustness/03Constraint_Parsing_Errors/output"
