...
class RobustnessExperimentRunner:
    ...
    def check_prerequisites(self):
        ...
        # 检查原始数据文件
        original_data_paths = [
            "/home/deep/TimeSeries/Agent_V2/output/01_preprocessed",
            "/home/deep/TimeSeries/Agent_V2/output/02_event_segments", 
            "/home/deep/TimeSeries/Agent_V2/output/04_TOU_filter/UK"
        ]
        
        for path in original_data_paths:
            if not os.path.exists(path):
                print(f"❌ 原始数据路径不存在: {path}")
                return False
