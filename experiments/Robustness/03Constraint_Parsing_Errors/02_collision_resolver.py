...
📁 输入路径: ./output/05_Initial_scheduling_optimization/{tariff_name}/house*/scheduled_events.csv
📁 输出路径: ./output/05_Collision_Resolved_Scheduling/{tariff_name}/house*/scheduled_events.csv
...
class P052CollisionResolver:
    ...
    def __init__(self, input_dir: str = "/home/deep/TimeSeries/Agent_V2/experiments/Robustness/03Constraint_Parsing_Errors/output/05_Initial_scheduling_optimization",
                 output_dir: str = "/home/deep/TimeSeries/Agent_V2/experiments/Robustness/03Constraint_Parsing_Errors/output/05_Collision_Resolved_Scheduling"):
