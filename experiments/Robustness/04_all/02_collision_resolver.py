...
class P052CollisionResolver:
    ...
    def __init__(self, input_dir: str = "/home/deep/TimeSeries/Agent_V2/experiments/Robustness/04_all/output/05_Initial_scheduling_optimization",
                 output_dir: str = "/home/deep/TimeSeries/Agent_V2/experiments/Robustness/04_all/output/05_Collision_Resolved_Scheduling"):
    ...
    def load_appliance_spaces(self, tariff_name: str):
        ...
        # 🎯 构建错误约束文件路径
        error_constraints_base = "/home/deep/TimeSeries/Agent_V2/experiments/Robustness/04_all/Error_data/UK"
    ...
    def resolve_collisions_for_house(
        ...
        # 添加分组字段到SUCCESS事件 - 基于电器名称和调度日期
        df_success['ApplianceBase'] = df_success['appliance_name']
        df_success['EventDate'] = df_success['scheduled_start_time'].dt.date
        # 为每个分组内的事件分配序号
        df_success['SequenceNum'] = df_success.groupby(['ApplianceBase', 'EventDate']).cumcount().astype(str).str.zfill(2)
