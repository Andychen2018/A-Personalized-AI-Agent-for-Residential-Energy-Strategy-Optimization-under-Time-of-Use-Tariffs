...
输入：
- 电器工作空间：Error_data/UK/{tariff_name}/{house_id}/ (错误约束文件)
- 可调度事件：Noise_data/UK/{tariff_name}/{house_id}/ (噪声事件文件)
...
class EventScheduler:
    ...
    def get_appliance_spaces_path(self, house_id: str, season: str = None) -> str:
        ...
        # 🎯 修改为使用错误约束文件路径
        base_path = "/home/deep/TimeSeries/Agent_V2/experiments/Robustness/04_all/Error_data/UK"
    ...
    def get_events_path(self, house_id: str) -> str:
        """获取可调度事件文件路径 - 使用Noise_data路径"""
        # 🎯 使用Noise_data路径
        base_original_path = "/home/deep/TimeSeries/Agent_V2/experiments/Robustness/04_all/Noise_data"
        ...
        # 构建路径模式
        patterns = [
            f"{base_original_path}/UK/{tariff}/{house_id}/*.csv",
            f"{base_original_path}/UK/{tariff}/{house_id}/shiftable_event_masked_{tariff}.csv"
        ]
    ...
    def get_output_path(self, house_id: str, season: str = None) -> str:
        """获取输出文件路径 - 输出到鲁棒性实验目录"""
        # 🎯 修改为输出到鲁棒性实验目录
        base_path = "/home/deep/TimeSeries/Agent_V2/experiments/Robustness/04_all/output"
