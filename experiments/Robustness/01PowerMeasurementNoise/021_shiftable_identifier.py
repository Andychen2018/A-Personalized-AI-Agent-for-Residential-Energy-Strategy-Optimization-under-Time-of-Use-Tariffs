...
try:
    ...
    print("⚠️ 无法导入GPTProxyClient，某些功能可能不可用")
    GPTProxyClient = None
...
# 配置文件路径（使用原始配置）
SHIFT_DICT_PATH = os.path.join(BASE_DIR, "config/appliance_shiftability_dict.json")
THRESHOLD_DICT_PATH = os.path.join(BASE_DIR, "config/device_threshold_dict.json")

# 输出路径（功率测量噪声实验专用）
OUTPUT_PATH = os.path.join(EXPERIMENT_DIR, "output/02_behavior_modeling/02_1_appliance_shiftable_label.csv")
