...
class P052CollisionResolver:
    ...
    def __init__(self, input_dir: str = "./output/05_Initial_scheduling_optimization",
                 output_dir: str = "./output/05_Collision_Resolved_Scheduling"):
    ...
    def load_appliance_spaces(self, tariff_name: str):
        ...
        if tariff_name in ["Economy_7", "Economy_10"]:
            spaces_dir = os.path.join("./output/05_appliance_working_spaces/UK", tariff_name)
        else:
