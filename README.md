...
##  User Configuration Instructions (Basic Settings)
...
##  User Constraint Settings (Optional Extension)
...
| `04_min_duration_filter/` |  Events filtered by minimum duration feasibility. |
...
| `05_Initial_scheduling_optimization/` |  Initial scheduling plan before conflict resolution. |
| `05_Collision_Resolved_Scheduling/` |  Collision‑resolved schedule. |
| `05_event_split/` |  Post‑processing with event splitting when needed. |
...
###  Tool Module Description (Partial)
